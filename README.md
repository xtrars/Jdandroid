...
![Version 0.0.5](https://img.shields.io/badge/Version-0.0.5-informational.svg)
...
[`JDAndroid-0.0.5.apk`](release/JDAndroid-0.0.5.apk)), allow installation
...
**Fertige APK:** [`release/JDAndroid-0.0.5.apk`](release/JDAndroid-0.0.5.apk)
...
| Version | Datei |
|---|---|
| **0.0.5** (aktuell) | [`release/JDAndroid-0.0.5.apk`](release/JDAndroid-0.0.5.apk) |
| 0.0.4 | [`release/JDAndroid-0.0.4.apk`](release/JDAndroid-0.0.4.apk) |
...
interne `versionCode` zählt weiter hoch (1.5.7 = 23, 0.0.5 = 29), deshalb
lässt sich 0.0.5 problemlos über 1.5.7 installieren. Einzelheiten stehen im
