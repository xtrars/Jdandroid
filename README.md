...
[GitHub Releases](https://github.com/xtrars/Jdandroid/releases) page (currently `JDAndroid-0.7.0.apk`, with a
...
Minutentakt erneut hochgeladen; das Verschieben hat einen eigenen Balken. Das NFS-Ziel hat Vorrang vor dem
...
oder fest wählbar, dazu das Farbschema „Space“: Sternenhimmel mit Lage-Parallaxe,
...
|---|---|---|
| **0.7.0** (aktuell) | 60 | [Release v0.7.0](https://github.com/xtrars/Jdandroid/releases/tag/v0.7.0) · [`release/JDAndroid-0.7.0.apk`](release/JDAndroid-0.7.0.apk) |
...
| 0.6.2 | 57 | [Release v0.6.2](https://github.com/xtrars/Jdandroid/releases/tag/v0.6.2) · [`release/JDAndroid-0.6.2.apk`](release/JDAndroid-0.6.2.apk) |
| 0.6.1 | 56 | [Release v0.6.1](https://github.com/xtrars/Jdandroid/releases/tag/v0.6.1) · [`release/JDAndroid-0.6.1.apk`](release/JDAndroid-0.6.1.apk) |
