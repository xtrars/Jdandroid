...
![Version 0.0.7](https://img.shields.io/badge/Version-0.0.7-informational.svg)
...
[`JDAndroid-0.0.7.apk`](release/JDAndroid-0.0.7.apk)), allow installation
...
**Fertige APK:** [`release/JDAndroid-0.0.7.apk`](release/JDAndroid-0.0.7.apk)
...
| Version | Datei |
|---|---|
| **0.0.7** (aktuell) | [`release/JDAndroid-0.0.7.apk`](release/JDAndroid-0.0.7.apk) |
| 0.0.6 | [`release/JDAndroid-0.0.6.apk`](release/JDAndroid-0.0.6.apk) |
...
interne `versionCode` zählt weiter hoch (1.5.7 = 23, 0.0.7 = 31), deshalb
lässt sich 0.0.7 problemlos über 1.5.7 installieren. Einzelheiten stehen im
