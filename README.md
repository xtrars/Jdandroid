...
![Version 0.0.6](https://img.shields.io/badge/Version-0.0.6-informational.svg)
...
[`JDAndroid-0.0.6.apk`](release/JDAndroid-0.0.6.apk)), allow installation
...
**Fertige APK:** [`release/JDAndroid-0.0.6.apk`](release/JDAndroid-0.0.6.apk)
...
| Version | Datei |
|---|---|
| **0.0.6** (aktuell) | [`release/JDAndroid-0.0.6.apk`](release/JDAndroid-0.0.6.apk) |
| 0.0.5 | [`release/JDAndroid-0.0.5.apk`](release/JDAndroid-0.0.5.apk) |
...
interne `versionCode` zählt weiter hoch (1.5.7 = 23, 0.0.6 = 30), deshalb
lässt sich 0.0.6 problemlos über 1.5.7 installieren. Einzelheiten stehen im
