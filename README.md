...
![Version 0.0.12](https://img.shields.io/badge/Version-0.0.12-informational.svg)
...
[`JDAndroid-0.0.12.apk`](release/JDAndroid-0.0.12.apk)), allow installation
...
**Fertige APK:** [`release/JDAndroid-0.0.12.apk`](release/JDAndroid-0.0.12.apk)
...
| Version | Datei |
|---|---|
| **0.0.12** (aktuell) | [`release/JDAndroid-0.0.12.apk`](release/JDAndroid-0.0.12.apk) |
...
interne `versionCode` zählt weiter hoch (1.5.7 = 23, 0.0.12 = 36), deshalb
lässt sich 0.0.12 problemlos über 1.5.7 installieren. Einzelheiten stehen im
