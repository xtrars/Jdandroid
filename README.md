...
![Version 0.6.4](https://img.shields.io/badge/Version-0.6.4-informational.svg)
...
[GitHub Releases](https://github.com/xtrars/Jdandroid/releases) page (currently `JDAndroid-0.6.4.apk`, with a
...
|---|---|---|
| **0.6.4** (aktuell) | 59 | [Release v0.6.4](https://github.com/xtrars/Jdandroid/releases/tag/v0.6.4) · [`release/JDAndroid-0.6.4.apk`](release/JDAndroid-0.6.4.apk) |
