...
![Version 0.0.9](https://img.shields.io/badge/Version-0.0.9-informational.svg)
...
[`JDAndroid-0.0.9.apk`](release/JDAndroid-0.0.9.apk)), allow installation
...
**Fertige APK:** [`release/JDAndroid-0.0.9.apk`](release/JDAndroid-0.0.9.apk)
...
| Version | Datei |
|---|---|
| **0.0.9** (aktuell) | [`release/JDAndroid-0.0.9.apk`](release/JDAndroid-0.0.9.apk) |
...
interne `versionCode` zählt weiter hoch (1.5.7 = 23, 0.0.9 = 33), deshalb
lässt sich 0.0.9 problemlos über 1.5.7 installieren. Einzelheiten stehen im
