...
![Version 0.4.2](https://img.shields.io/badge/Version-0.4.2-informational.svg)
...
[GitHub Releases](https://github.com/xtrars/Jdandroid/releases) page (currently `JDAndroid-0.4.2.apk`, with a
...
|---|---|---|
| **0.4.2** (aktuell) | 48 | [Release v0.4.2](https://github.com/xtrars/Jdandroid/releases/tag/v0.4.2) · [`release/JDAndroid-0.4.2.apk`](release/JDAndroid-0.4.2.apk) |
