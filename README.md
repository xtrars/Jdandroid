...
[GitHub Releases](https://github.com/xtrars/Jdandroid/releases) page (currently `JDAndroid-0.7.1.apk`, with a
...
|---|---|---|
| **0.7.1** (aktuell) | 61 | [Release v0.7.1](https://github.com/xtrars/Jdandroid/releases/tag/v0.7.1) · [`release/JDAndroid-0.7.1.apk`](release/JDAndroid-0.7.1.apk) |
