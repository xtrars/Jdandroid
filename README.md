...
![Version 0.4.3](https://img.shields.io/badge/Version-0.4.3-informational.svg)
...
[GitHub Releases](https://github.com/xtrars/Jdandroid/releases) page (currently `JDAndroid-0.4.3.apk`, with a
...
|---|---|---|
| **0.4.3** (aktuell) | 49 | [Release v0.4.3](https://github.com/xtrars/Jdandroid/releases/tag/v0.4.3) · [`release/JDAndroid-0.4.3.apk`](release/JDAndroid-0.4.3.apk) |
