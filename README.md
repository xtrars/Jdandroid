...
![Version 0.4.7](https://img.shields.io/badge/Version-0.4.7-informational.svg)
...
[GitHub Releases](https://github.com/xtrars/Jdandroid/releases) page (currently `JDAndroid-0.4.7.apk`, with a
...
|---|---|---|
| **0.4.7** (aktuell) | 53 | [Release v0.4.7](https://github.com/xtrars/Jdandroid/releases/tag/v0.4.7) · [`release/JDAndroid-0.4.7.apk`](release/JDAndroid-0.4.7.apk) |
