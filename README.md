...
[GitHub Releases](https://github.com/xtrars/Jdandroid/releases) page (currently `JDAndroid-0.5.0.apk`, with a
...
oder fest wählbar, dazu das Farbschema „Gamer“ (Neon-Akzente auf
weltraumdunklen Flächen, die einzige eigene Palette). Alle Schaltflächen bleiben auch bei eingeblendeter
...
|---|---|---|
| **0.5.0** (aktuell) | 54 | [Release v0.5.0](https://github.com/xtrars/Jdandroid/releases/tag/v0.5.0) · [`release/JDAndroid-0.5.0.apk`](release/JDAndroid-0.5.0.apk) |
