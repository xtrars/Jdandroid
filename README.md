...
![Version 0.8.2](https://img.shields.io/badge/Version-0.8.2-informational.svg)
...
[GitHub Releases](https://github.com/xtrars/Jdandroid/releases) page (currently `JDAndroid-0.8.2.apk`, with a
...
|---|---|---|
| **0.8.2** (aktuell) | 64 | [Release v0.8.2](https://github.com/xtrars/Jdandroid/releases/tag/v0.8.2) · [`release/JDAndroid-0.8.2.apk`](release/JDAndroid-0.8.2.apk) |
| 0.8.1 | 63 | [Release v0.8.1](https://github.com/xtrars/Jdandroid/releases/tag/v0.8.1) · [`release/JDAndroid-0.8.1.apk`](release/JDAndroid-0.8.1.apk) |
