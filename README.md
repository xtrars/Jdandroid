...
![Version 0.4.6](https://img.shields.io/badge/Version-0.4.6-informational.svg)
...
[GitHub Releases](https://github.com/xtrars/Jdandroid/releases) page (currently `JDAndroid-0.4.6.apk`, with a
...
|---|---|---|
| **0.4.6** (aktuell) | 52 | [Release v0.4.6](https://github.com/xtrars/Jdandroid/releases/tag/v0.4.6) · [`release/JDAndroid-0.4.6.apk`](release/JDAndroid-0.4.6.apk) |
