...
![Version 0.0.4](https://img.shields.io/badge/Version-0.0.4-informational.svg)
...
[`JDAndroid-0.0.4.apk`](release/JDAndroid-0.0.4.apk)), allow installation
...
**Fertige APK:** [`release/JDAndroid-0.0.4.apk`](release/JDAndroid-0.0.4.apk)
...
- 1–99 gleichzeitige Downloads, globale Geschwindigkeitsbegrenzung (KiB/s),
...
| Version | Datei |
|---|---|
| **0.0.4** (aktuell) | [`release/JDAndroid-0.0.4.apk`](release/JDAndroid-0.0.4.apk) |
| 0.0.3 | [`release/JDAndroid-0.0.3.apk`](release/JDAndroid-0.0.3.apk) |
| 0.0.2 | [`release/JDAndroid-0.0.2.apk`](release/JDAndroid-0.0.2.apk) |
| 0.0.1 | [`release/JDAndroid-0.0.1.apk`](release/JDAndroid-0.0.1.apk) |
| 1.5.7 (vor dem Versionsreset) | [`release/JDAndroid-1.5.7.apk`](release/JDAndroid-1.5.7.apk) |
...
interne `versionCode` zählt weiter hoch (1.5.7 = 23, 0.0.4 = 28), deshalb
lässt sich 0.0.4 problemlos über 1.5.7 installieren. Einzelheiten stehen im
