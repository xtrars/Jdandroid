...
![Version 0.1.1](https://img.shields.io/badge/Version-0.3.0-informational.svg)
...
[GitHub Releases](https://github.com/xtrars/Jdandroid/releases) page (currently `JDAndroid-0.3.0.apk`, with a
...
|---|---|---|
| **0.3.0** (aktuell) | 45 | [Release v0.3.0](https://github.com/xtrars/Jdandroid/releases/tag/v0.3.0) · [`release/JDAndroid-0.3.0.apk`](release/JDAndroid-0.3.0.apk) |
