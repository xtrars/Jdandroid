...
![Version 0.0.8](https://img.shields.io/badge/Version-0.0.8-informational.svg)
...
[`JDAndroid-0.0.8.apk`](release/JDAndroid-0.0.8.apk)), allow installation
...
**Fertige APK:** [`release/JDAndroid-0.0.8.apk`](release/JDAndroid-0.0.8.apk)
...
| Version | Datei |
|---|---|
| **0.0.8** (aktuell) | [`release/JDAndroid-0.0.8.apk`](release/JDAndroid-0.0.8.apk) |
...
interne `versionCode` zählt weiter hoch (1.5.7 = 23, 0.0.8 = 32), deshalb
lässt sich 0.0.8 problemlos über 1.5.7 installieren. Einzelheiten stehen im
