...
![Version 0.0.13](https://img.shields.io/badge/Version-0.0.13-informational.svg)
...
[`JDAndroid-0.0.13.apk`](release/JDAndroid-0.0.13.apk)), allow installation
...
**Fertige APK:** [`release/JDAndroid-0.0.13.apk`](release/JDAndroid-0.0.13.apk)
...
| Version | Datei |
|---|---|
| **0.0.13** (aktuell) | [`release/JDAndroid-0.0.13.apk`](release/JDAndroid-0.0.13.apk) |
...
interne `versionCode` zählt weiter hoch (1.5.7 = 23, 0.0.13 = 37), deshalb
lässt sich 0.0.13 problemlos über 1.5.7 installieren. Einzelheiten stehen im
