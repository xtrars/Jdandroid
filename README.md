...
[GitHub Releases](https://github.com/xtrars/Jdandroid/releases) page (currently `JDAndroid-0.6.2.apk`, with a
...
|---|---|---|
| **0.6.2** (aktuell) | 57 | [Release v0.6.2](https://github.com/xtrars/Jdandroid/releases/tag/v0.6.2) · [`release/JDAndroid-0.6.2.apk`](release/JDAndroid-0.6.2.apk) |
